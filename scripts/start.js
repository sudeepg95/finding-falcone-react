...
const { yarnLockFile, appHtml, appIndexJs, appPath, appPackageJson, appPublic } = paths;

const { cyan, yellow, bold } = chalk;
...
if (process.env.HOST) {
  console.log(
    cyan(`Attempting to bind to HOST environment variable: ${yellow(bold(process.env.HOST))}`)
  );
  console.log("If this was unintentional, check that you haven't mistakenly set it in your shell.");
  console.log(`Learn more here: ${yellow('https://bit.ly/CRA-advanced-config')}`);
  console.log();
}
